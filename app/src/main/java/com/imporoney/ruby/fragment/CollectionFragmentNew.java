...
import com.imporoney.ruby.adapter.CollectionRecyclerviewAdapter;
 ...
 * Use the {@link CollectionFragmentNew#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CollectionFragmentNew extends BaseFragment {
    ...
    public static CollectionFragmentNew newInstance() {
        CollectionFragmentNew fragment = new CollectionFragmentNew();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.collection_fragment_new, container, false);
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new CollectionRecyclerviewAdapter(getActivity(), things));
